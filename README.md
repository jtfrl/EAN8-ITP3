...
- pImg.h: código fonte que dá suporte ao io_pbm.h para realizar os processos intermediários de identificação do código EAN-8;
- io_pbm.c: carregamento de imagem e detecção de barra em arquivos .pbm;
